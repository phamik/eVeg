...
class App extends Component{
	...
	getProducts(){
        ...
        console.log(this.state.products); //test if json file was loaded
			})
	}
	componentWillMount(){
		// localStorage.clear();
	...
	componentDidMount(){
		window.addEventListener('onbeforeunload', this.handleLeavePage);
	...
	handleLeavePage(event){
		...
		// alert("Are you sure you want to exit? You might loose shopping progress!");
	...
	handleAddToCart(selectedProducts){
		...
		let description = selectedProducts.description;
